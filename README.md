...
1. Скачайте и разархивируйте в домашнюю директорию файл (если ссылка не открывается, скопируйте и вставьте её в отдельное окно браузера) http://timesheets.parusinf.ru/linux/timesheets.zip
