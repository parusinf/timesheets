      ...
      style: TextButton.styleFrom(
        textStyle: TextStyle(
          color: date.month == widget.selectedDate!.month && date.year == widget.selectedDate!.year
              ? Theme.of(context).toggleableActiveColor : null,
          fontWeight: date.month == DateTime.now().month && date.year == DateTime.now().year
              ? FontWeight.bold : null,
          fontStyle: date.month == widget.selectedDate!.month && date.year == widget.selectedDate!.year
