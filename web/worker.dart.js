...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
      ...
      if (normalize) {
        ...
        if (!A.isStrongTopType(baseType))
          if (!(baseType === type$.Null || baseType === type$.JSNull))
            if (baseKind !== 7)
              t1 = baseKind === 8 && A.isNoShowllable(baseType._primary);
            else
              t1 = true;
          else
            t1 = true;
        ...
        if (t1)
          ...
          if (starArgument._kind === 8 && A.isNoShowllable(starArgument._primary))
            return starArgument;
          else
    ...
    isNoShowllable(t) {
      ...
      if (!(t === type$.Null || t === type$.JSNull))
        if (!A.isStrongTopType(t))
          if (kind !== 7)
            if (!(kind === 6 && A.isNoShowllable(t._primary)))
              t1 = kind === 8 && A.isNoShowllable(t._primary);
            else
              t1 = true;
          else
            t1 = true;
  ...
  A.Number.prototype = {$isNoShowmber: 1};
