...
class Organization extends DataClass implements Insertable<Organization> {
  ...
  final String name;
  final String inn;
  Organization({@required this.id, @required this.name, this.inn});
  ...
  Organization copyWith({int id, String name, String inn}) => Organization(
        id: id ?? this.id,
        name: name ?? this.name,
        inn: inn ?? this.inn,
      );
...
class Organizations extends Table with TableInfo<Organizations, Organization> {
  ...
  final String _alias;
  Organizations(this._db, [this._alias]);
  ...
  @override
  Organizations get asDslTable => this;
  @override
  String get $tableName => _alias ?? 'organizations';
  @override
  final String actualTableName = 'organizations';
  @override
  ...
  Organization map(Map<String, dynamic> data, {String tablePrefix}) {
    ...
    return Organization.fromData(data, _db, prefix: effectivePrefix);
  }

  @override
  Organizations createAlias(String alias) {
    return Organizations(_db, alias);
  }
...
class Group extends DataClass implements Insertable<Group> {
  ...
  factory Group.fromData(Map<String, dynamic> data, GeneratedDatabase db,
    ...
    return Group(
      id: intType.mapFromDatabaseResponse(data['${effectivePrefix}id']),
      organizationId: intType
          .mapFromDatabaseResponse(data['${effectivePrefix}organizationId']),
      name: stringType.mapFromDatabaseResponse(data['${effectivePrefix}name']),
      scheduleId:
          intType.mapFromDatabaseResponse(data['${effectivePrefix}scheduleId']),
    );
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || organizationId != null) {
      map['organizationId'] = Variable<int>(organizationId);
    }
    if (!nullToAbsent || name != null) {
      map['name'] = Variable<String>(name);
    }
  ...
  Group copyWith({int id, int organizationId, String name, int scheduleId}) =>
      Group(
        id: id ?? this.id,
  ...
  int get hashCode => $mrjf($mrjc(
      id.hashCode,
      $mrjc(
          organizationId.hashCode, $mrjc(name.hashCode, scheduleId.hashCode))));
  @override
  bool operator ==(dynamic other) =>
      identical(this, other) ||
      (other is Group &&
...
class GroupsCompanion extends UpdateCompanion<Group> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (organizationId.present) {
      map['organizationId'] = Variable<int>(organizationId.value);
    }
    if (name.present) {
      map['name'] = Variable<String>(name.value);
    }
...
class Groups extends Table with TableInfo<Groups, Group> {
  ...
  GeneratedIntColumn _organizationId;
  GeneratedIntColumn get organizationId =>
      _organizationId ??= _constructOrganizationId();
  GeneratedIntColumn _constructOrganizationId() {
    return GeneratedIntColumn('organizationId', $tableName, false,
        $customConstraints: 'NOT NULL REFERENCES organizations (id)');
  }
  ...
  @override
  List<GeneratedColumn> get $columns => [id, organizationId, name, scheduleId];
  @override
    ...
    if (data.containsKey('organizationId')) {
      context.handle(
          ...
          organizationId.isAcceptableOrUnknown(
              data['organizationId'], _organizationIdMeta));
    } else if (isInserting) {
...
class PgLink extends DataClass implements Insertable<PgLink> {
  final int id;
  final int personId;
  final int groupId;
  PgLink({@required this.id, @required this.personId, @required this.groupId});
  factory PgLink.fromData(Map<String, dynamic> data, GeneratedDatabase db,
      {String prefix}) {
    final effectivePrefix = prefix ?? '';
    final intType = db.typeSystem.forDartType<int>();
    return PgLink(
  ...
  PgLinksCompanion toCompanion(bool nullToAbsent) {
    return PgLinksCompanion(
      id: id == null && nullToAbsent ? const Value.absent() : Value(id),
  ...
  factory PgLink.fromJson(Map<String, dynamic> json,
      {ValueSerializer serializer}) {
    serializer ??= moorRuntimeOptions.defaultSerializer;
    return PgLink(
      id: serializer.fromJson<int>(json['id']),
  ...
  PgLink copyWith({int id, int personId, int groupId}) => PgLink(
        id: id ?? this.id,
...
class PgLinksCompanion extends UpdateCompanion<PgLink> {
  final Value<int> id;
  final Value<int> personId;
  final Value<int> groupId;
  const PgLinksCompanion({
    this.id = const Value.absent(),
    this.personId = const Value.absent(),
    this.groupId = const Value.absent(),
  });
  PgLinksCompanion.insert({
    this.id = const Value.absent(),
    @required int personId,
    @required int groupId,
  })  : personId = Value(personId),
        groupId = Value(groupId);
  static Insertable<PgLink> custom({
    Expression<int> id,
...
class PgLinks extends Table with TableInfo<PgLinks, PgLink> {
  final GeneratedDatabase _db;
  final String _alias;
  PgLinks(this._db, [this._alias]);
  final VerificationMeta _idMeta = const VerificationMeta('id');
  GeneratedIntColumn _id;
  GeneratedIntColumn get id => _id ??= _constructId();
  GeneratedIntColumn _constructId() {
  ...
  @override
  PgLinks get asDslTable => this;
  @override
  String get $tableName => _alias ?? 'pg_links';
  @override
  final String actualTableName = 'pg_links';
  @override
  VerificationContext validateIntegrity(Insertable<PgLink> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PgLink map(Map<String, dynamic> data, {String tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : null;
    return PgLink.fromData(data, _db, prefix: effectivePrefix);
  }

  @override
  PgLinks createAlias(String alias) {
    return PgLinks(_db, alias);
  }
...
class Timesheet extends DataClass implements Insertable<Timesheet> {
  ...
  factory Timesheet.fromData(Map<String, dynamic> data, GeneratedDatabase db,
    ...
    return Timesheet(
      id: intType.mapFromDatabaseResponse(data['${effectivePrefix}id']),
      pgLinkId:
          intType.mapFromDatabaseResponse(data['${effectivePrefix}pgLinkId']),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || pgLinkId != null) {
      map['pgLinkId'] = Variable<int>(pgLinkId);
    }
  ...
  TimesheetsCompanion toCompanion(bool nullToAbsent) {
    return TimesheetsCompanion(
      id: id == null && nullToAbsent ? const Value.absent() : Value(id),
      pgLinkId: pgLinkId == null && nullToAbsent
          ? const Value.absent()
          : Value(pgLinkId),
  ...
  factory Timesheet.fromJson(Map<String, dynamic> json,
    ...
    return Timesheet(
      id: serializer.fromJson<int>(json['id']),
      pgLinkId: serializer.fromJson<int>(json['pgLinkId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'pgLinkId': serializer.toJson<int>(pgLinkId),
  ...
  Timesheet copyWith(
      ...
      Timesheet(
        id: id ?? this.id,
        pgLinkId: pgLinkId ?? this.pgLinkId,
...
class TimesheetsCompanion extends UpdateCompanion<Timesheet> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pgLinkId.present) {
      map['pgLinkId'] = Variable<int>(pgLinkId.value);
    }
...
class Timesheets extends Table with TableInfo<Timesheets, Timesheet> {
  ...
  final VerificationMeta _pgLinkIdMeta = const VerificationMeta('pgLinkId');
  GeneratedIntColumn _pgLinkId;
  GeneratedIntColumn get pgLinkId => _pgLinkId ??= _constructPgLinkId();
  GeneratedIntColumn _constructPgLinkId() {
    return GeneratedIntColumn('pgLinkId', $tableName, false,
        $customConstraints:
            'NOT NULL REFERENCES pg_links (id) ON DELETE CASCADE');
  }
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, pgLinkId, attendanceDate, hoursNumber];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<Timesheet> instance,
    ...
    if (data.containsKey('pgLinkId')) {
      context.handle(_pgLinkIdMeta,
          pgLinkId.isAcceptableOrUnknown(data['pgLinkId'], _pgLinkIdMeta));
    } else if (isInserting) {
      context.missing(_pgLinkIdMeta);
    }
...
abstract class _$Db extends GeneratedDatabase {
  ...
  Organizations get organizations => _organizations ??= Organizations(this);
  Index _organizationsIndex;
  Index get organizationsIndex => _organizationsIndex ??= Index(
      'organizations_index',
      'CREATE UNIQUE INDEX organizations_index ON organizations (name);');
  ...
  PgLinks _pgLinks;
  PgLinks get pgLinks => _pgLinks ??= PgLinks(this);
  Index _pgLinksIndex;
  Index get pgLinksIndex => _pgLinksIndex ??= Index('pg_links_index',
  ...
  OrganizationsDao _organizationsDao;
  OrganizationsDao get organizationsDao =>
      _organizationsDao ??= OrganizationsDao(this as Db);
  ...
  PgLinksDao _pgLinksDao;
  PgLinksDao get pgLinksDao => _pgLinksDao ??= PgLinksDao(this as Db);
  ...
  Organization _rowToOrganization(QueryRow row) {
    return Organization(
      id: row.readInt('id'),
  ...
  Selectable<Organization> _previousOrganization(String organizationName) {
    return customSelect(
        'SELECT *\n  FROM organizations\n WHERE name =\n       (\n         SELECT MAX(name)\n           FROM organizations\n          WHERE name < :organizationName\n       )',
        variables: [Variable.withString(organizationName)],
        readsFrom: {organizations}).map(_rowToOrganization);
  }

  Group _rowToGroup(QueryRow row) {
    return Group(
      id: row.readInt('id'),
      organizationId: row.readInt('organizationId'),
      name: row.readString('name'),
      scheduleId: row.readInt('scheduleId'),
    );
  }

  Selectable<Group> _firstOrganizationGroup(int organizationId) {
    return customSelect(
  ...
  Selectable<Group> _previousGroup(int organizationId, String groupName) {
    return customSelect(
        'SELECT *\n  FROM "groups"\n WHERE organizationId = :organizationId\n   AND name =\n       (\n         SELECT MAX(name)\n           FROM "groups"\n          WHERE name < :groupName\n       )',
        variables: [
          Variable.withInt(organizationId),
          Variable.withString(groupName)
        ],
        readsFrom: {
          groups
        }).map(_rowToGroup);
  ...
  Selectable<GroupsViewResult> _groupsView(int organizationId) {
    return customSelect(
        ...
        variables: [Variable.withInt(organizationId)],
        readsFrom: {groups, schedules, pgLinks}).map(_rowToGroupsViewResult);
  }

  PersonsInGroupResult _rowToPersonsInGroupResult(QueryRow row) {
    return PersonsInGroupResult(
      pgLinkId: row.readInt('pgLinkId'),
  ...
  Selectable<PersonsInGroupResult> _personsInGroup(int groupId) {
    return customSelect(
        ...
        readsFrom: {pgLinks, persons}).map(_rowToPersonsInGroupResult);
  }
  ...
  Selectable<Timesheet> _timesheetsView(int pgLinkId, String period) {
    return customSelect(
        'SELECT *\n  FROM timesheets\n WHERE pgLinkId = :pgLinkId\n   AND attendanceDate BETWEEN date(:period, \'start of month\') AND :period',
        variables: [Variable.withInt(pgLinkId), Variable.withString(period)],
        readsFrom: {timesheets}).map(_rowToTimesheet);
  }

  Selectable<Organization> _activeOrganization() {
    return customSelect(
        'SELECT O.*\n  FROM settings S\n INNER JOIN organizations O ON O.id = S.intValue\n WHERE S.name = \'activeOrganization\'',
        variables: [],
        readsFrom: {settings, organizations}).map(_rowToOrganization);
  }

  Future<int> _setActiveOrganization(int id) {
    return customUpdate(
      'UPDATE settings SET intValue = :id WHERE name = \'activeOrganization\'',
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules(
        [
          WritePropagation(
            on: TableUpdateQuery.onTableName('pg_links',
...
mixin _$OrganizationsDaoMixin on DatabaseAccessor<Db> {}
...
mixin _$PgLinksDaoMixin on DatabaseAccessor<Db> {}
