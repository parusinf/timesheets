...
Программа предназначена для мобильной регистрации табелей посещаемости персон в детсадах и дополнительном образовании; обмена табелями посещаемости между пользователями программы и учётной системой через Telegram или электронную почту; формирования сводных отчётов по группам и по типам питания для заказа питания.

### 1.2. Пользователи

В настоящее время программа используется в детсадах г.Балашихи и г.Королёва.
...
* по обратной связи в системе регистрации проблем [https://github.com/parusinf/timesheets/issues](https://github.com/parusinf/timesheets/issues)
