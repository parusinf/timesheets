...
Программа предназначена для: 1) мобильной регистрации табелей посещаемости персон в детсадах и дополнительном образовании; 2) обмена табелями посещаемости в формате CSV между пользователями либо между пользователем и учётной системой через Telegram или электронную почту; 3) формирования сводных отчётов по группам и по типам питания для заказа питания.
